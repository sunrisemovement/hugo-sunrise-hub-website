...
/* harmony import */ var _MonthOfYear__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MonthOfYear */ "./src/Home/Events/MonthOfYear.ts");
/* harmony import */ var _DayRange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DayRange */ "./src/Home/Events/DayRange.ts");
...
let Calendar = Calendar_1 = class Calendar extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
    constructor() {
        ...
        this.events = [];
        this.selected = null;
        this.month = _MonthOfYear__WEBPACK_IMPORTED_MODULE_2__["default"].now();
    }
    static register() {
    ...
    render() {
         ...
         */
        const days = Array.from(new _DayRange__WEBPACK_IMPORTED_MODULE_3__["default"](this.month.firstDay().nearestPreviousSunday(), this.month.lastDay().nearestNextSaturday()));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DayOfYear; });
class DayOfYear {
    constructor(year, month, day) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.cachedNearestPreviousSunday = null;
        this.cachedNearestNextSaturday = null;
    }
    equals(other) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DayRange; });
class DayRange {
...
/* harmony import */ var _Map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Map */ "./src/Home/Events/Map.ts");
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Icon */ "./src/Home/Events/Icon.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Details.dependencies = [_Map__WEBPACK_IMPORTED_MODULE_2__["default"], _Icon__WEBPACK_IMPORTED_MODULE_3__["default"]];
...
/* harmony import */ var _DayOfYear__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DayOfYear */ "./src/Home/Events/DayOfYear.ts");
/* harmony import */ var _TimeOfDay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TimeOfDay */ "./src/Home/Events/TimeOfDay.ts");
...
class Event {
    constructor({ description, title, url, address, place, start, coordinates, }) {
        ...
        this.time = new _TimeOfDay__WEBPACK_IMPORTED_MODULE_1__["default"](startDate.valueOf() % MILLIS_IN_A_DAY);
        this.date = new _DayOfYear__WEBPACK_IMPORTED_MODULE_0__["default"](startDate.getFullYear(), startDate.getMonth(), startDate.getDate());
    }
}
...
/***/ "./src/Home/Events/MonthOfYear.ts":
/*!****************************************!*\
  !*** ./src/Home/Events/MonthOfYear.ts ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MonthOfYear; });
/* harmony import */ var _DayOfYear__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DayOfYear */ "./src/Home/Events/DayOfYear.ts");
...
class MonthOfYear {
    ...
    firstDay() {
        if (!this.cachedFirst) {
            ...
            this.cachedFirst = new _DayOfYear__WEBPACK_IMPORTED_MODULE_0__["default"](date.getFullYear(), date.getMonth(), date.getDate());
        }
    ...
    lastDay() {
        if (!this.cachedLast) {
            ...
            date.setDate(0);
            this.cachedLast = new _DayOfYear__WEBPACK_IMPORTED_MODULE_0__["default"](date.getFullYear(), date.getMonth(), date.getDate());
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TimeOfDay; });
class TimeOfDay {
    constructor(millis) {
        this.millis = millis;
    }
